...
class AddTwoIntsRequest(genpy.Message):
  _md5sum = "14918f4d2baa4a78439836d5a3120174"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_9f.pack(_x.a, _x.b, _x.c, _x.d, _x.e, _x.f, _x.g, _x.h, _x.i))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.a, _x.b, _x.c, _x.d, _x.e, _x.f, _x.g, _x.h, _x.i,) = _struct_9f.unpack(str[start:end])
      return self
...
class AddTwoInts(object):
  ...
  _md5sum = '27ff5adccaca1d8baf20433bb5db9c3c'
