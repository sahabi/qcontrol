...
"""autogenerated by genpy from quad_control/TrajRequest.msg. Do not edit."""
import sys
...
class TrajRequest(genpy.Message):
  ...
  _type = "quad_control/TrajRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from quad_control/TrajResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class TrajResponse(genpy.Message):
  ...
  _type = "quad_control/TrajResponse"
  _has_header = False #flag to mark the presence of a Header object
...
"""
  ...
  _slot_types = ['quad_control/trajData[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = quad_control.msg.trajData()
        _x = val1
        start = end
        end += 16
