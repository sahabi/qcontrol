...
"""autogenerated by genpy from quad_control/Twist.msg. Do not edit."""
import sys
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.linear is None:
        self.linear = quad_control.msg.Vector3()
      if self.angular is None:
        self.angular = quad_control.msg.Vector3()
    else:
      self.linear = quad_control.msg.Vector3()
      self.angular = quad_control.msg.Vector3()
