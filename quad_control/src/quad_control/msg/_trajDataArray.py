...
"""autogenerated by genpy from quad_control/trajDataArray.msg. Do not edit."""
import sys
...
class trajDataArray(genpy.Message):
  _md5sum = "6800fddd4bf810897f1a5feb2ba6d4b2"
  _type = "quad_control/trajDataArray"
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(trajDataArray, self).__init__(*args, **kwds)
