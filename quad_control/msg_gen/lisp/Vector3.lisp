...
(cl:defmethod cl:initialize-instance :after ((m <Vector3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quad_control-msg:<Vector3> is deprecated: use quad_control-msg:Vector3 instead.")))
