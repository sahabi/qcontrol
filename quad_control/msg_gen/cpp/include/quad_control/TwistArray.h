/* Auto-generated by genmsg_cpp for file /home/sahabi/ws/sandbox/quad_control/msg/TwistArray.msg */
#ifndef QUAD_CONTROL_MESSAGE_TWISTARRAY_H
#define QUAD_CONTROL_MESSAGE_TWISTARRAY_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct TwistArray_ {
  ...
  typedef boost::shared_ptr< ::quad_control::TwistArray_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::quad_control::TwistArray_<ContainerAllocator>  const> ConstPtr;
}; // struct TwistArray
typedef  ::quad_control::TwistArray_<std::allocator<void> > TwistArray;

typedef boost::shared_ptr< ::quad_control::TwistArray> TwistArrayPtr;
typedef boost::shared_ptr< ::quad_control::TwistArray const> TwistArrayConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::quad_control::TwistArray_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::quad_control::TwistArray_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::quad_control::TwistArray_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::quad_control::TwistArray_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::quad_control::TwistArray_<ContainerAllocator> > {
  static const char* value() 
  {
    return "5cfe93154dc27101e73a4984a4f1dcb4";
  }

  static const char* value(const  ::quad_control::TwistArray_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x5cfe93154dc27101ULL;
  static const uint64_t static_value2 = 0xe73a4984a4f1dcb4ULL;
};

template<class ContainerAllocator>
struct DataType< ::quad_control::TwistArray_<ContainerAllocator> > {
  static const char* value() 
  {
    return "quad_control/TwistArray";
  }
...
template<class ContainerAllocator>
struct Definition< ::quad_control::TwistArray_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::quad_control::TwistArray_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::quad_control::TwistArray_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::quad_control::TwistArray_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::quad_control::TwistArray_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::quad_control::TwistArray_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // QUAD_CONTROL_MESSAGE_TWISTARRAY_H
